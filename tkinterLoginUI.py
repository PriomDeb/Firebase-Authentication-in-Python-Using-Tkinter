...
def play_audio(click=False, email_sent=False, error=False):
    ...
    if click:
        try:
            pygame.mixer.music.load("authenticationUI/clicks.mp3")
    ...
    if email_sent:
        try:
            pygame.mixer.music.load("authenticationUI/emailSent.mp3")
            pygame.mixer.music.play(loops=0)
        except:
            pass
    ...
    if error:
        try:
            pygame.mixer.music.load("authenticationUI/error.mp3")
            pygame.mixer.music.play(loops=0)
        except:
            pass
...
class DrawAuthentication:
    ...
    def drawLogin(self):
        ...
        main_ui = Image.open("authenticationUI/loginUI.png")
    ...
    def sign_up_draw(self):
        ...
        main_ui = Image.open("authenticationUI/signUpUI.png")
        resize_main_ui = main_ui.resize((window_x, window_y))
        resized_main_ui = ImageTk.PhotoImage(resize_main_ui)
    ...
    def draw_resend_email_verification(self):
        ...
        main_ui = Image.open("authenticationUI/verifyEmail.png")
        resize_main_ui = main_ui.resize((window_x, window_y))
        resized_main_ui = ImageTk.PhotoImage(resize_main_ui)
    ...
    def draw_reset_password(self):
        ...
        main_ui = Image.open("authenticationUI/resetPassword.png")
        resize_main_ui = main_ui.resize((window_x, window_y))
        resized_main_ui = ImageTk.PhotoImage(resize_main_ui)
    ...
    def draw_no_internet(self):
        ...
        main_ui = Image.open("authenticationUI/internetConnection.png")
        resize_main_ui = main_ui.resize((window_x, window_y))
        resized_main_ui = ImageTk.PhotoImage(resize_main_ui)
    ...
    def draw_terms_and_condition(self):
        ...
        main_ui = Image.open("authenticationUI/terms.png")
        resize_main_ui = main_ui.resize((window_x, window_y))
        resized_main_ui = ImageTk.PhotoImage(resize_main_ui)
